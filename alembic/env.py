...
dsn_sync = settings.POSTGRES_DSN.replace('postgresql+asyncpg', 'postgresql+psycopg2')
dsn_sync = dsn_sync.replace('localhost', 'db')
dsn_sync = dsn_sync.replace('5438', '5432')
